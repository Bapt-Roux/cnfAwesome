...
function hotkeys:init(args)
	...
	appswitcher_keys_move = {
		...
		{
			{ env.mod }, "o", function() appswitcher:switch({ reverse = true }) end,
	...
	keyseq[3] = {
		...
		{
			{}, "w", function () awful.spawn.with_shell(env.web) end,
			{ description = "launch web browser", group = "Apps launcher" }
		},
		{
			{}, "m", function () awful.spawn.with_shell(env.mail) end,
			{ description = "launch mail client", group = "Apps launcher" }
		},
		{
			{}, "c", function () awful.spawn.with_shell(env.chat) end,
			{ description = "launch chat client", group = "Apps launcher" }
		},
		{
			{}, "v", function () awful.spawn.with_shell(env.pdf) end,
			{ description = "launch pdf viewer", group = "Apps launcher" }
		},
		{
			{}, "f", function () awful.spawn.with_shell(env.fm) end,
			{ description = "launch file manager", group = "Apps launcher" }
		},
		{
			{}, "e", function () awful.spawn.with_shell(env.geditor) end,
			{ description = "launch editor", group = "Apps launcher" }
		},
		{
			{}, "p", function () awful.spawn.with_shell(env.player) end,
			{ description = "launch music player", group = "Apps launcher" }
		},
  }
-- }}}
	...
	self.raw.root = {
		...
		},
		{
			...
			{ description = "Move client to right", group = "Client focus" }
		},
		{
			{ env.mod, "Shift"  }, "h", focus_swap_byd("left"),
			{ description = "Move client to left", group = "Client focus" }
		},
		{
			{ env.mod, "Shift"  }, "k", focus_swap_byd("up"),
			{ description = "Move client upper", group = "Client focus" }
		},
		{
			{ env.mod, "Shift"  }, "j", focus_swap_byd("down"),
			{ description = "Move client lower", group = "Client focus" }
		},
		-- {
		...
		{
			{ env.mod }, "o", nil, function() appswitcher:show({ filter = current, reverse = true }) end,
		...
		{
			{ env.mod, "Shift" }, "o", nil, function() appswitcher:show({ filter = allscr, reverse = true }) end,
		...
		{
			{ env.mod }, ";", function() awful.layout.set(awful.layout.layouts[1]) end,
			{ description = "Select first layout", group = "Layouts" }
		},
		{
			{ env.mod }, ",", function() awful.layout.set(awful.layout.layouts[2]) end,
			{ description = "Select second layout", group = "Layouts" }
		},
		{
			{ env.mod }, ".", function() awful.layout.set(awful.layout.layouts[3]) end,
			{ description = "Select third layout", group = "Layouts" }
		},
		{
			{ env.mod }, "p", function() awful.layout.set(awful.layout.layouts[4]) end,
			{ description = "Select fourth layout", group = "Layouts" }
		},
	}
	...
	self.raw.client = {
		...
		-- },
		{
			{ env.mod, "Shift"}, ";", function(c) c:kill() end,
			{ description = "Close", group = "Client keys" }
		},
		{
			{ env.mod}, "f", awful.client.floating.toggle,
